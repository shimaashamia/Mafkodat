...
<div class="container" style="text-align-last: center;">
            ...
            <tbody>
              ...
              <div class="maf" style="text-align-last: left;">
               <img src="../images/searching3.png" alt="description here" width="500" height="450" style="transform: scaleX(-1); float:left;" />
               </div>

               
                
                <div class="maf" style="text-align-last: right; padding-top: 150px; font-size: 20px;">
               <h2 style="color:#6C63FF; font-family: Tajawal;">مفقودات</h2>
               <p>
               هنا يمكنك إيجاد كل ما فقدته داخل الحرم الجامعي كما ويمكنك
               </p>      الإعلان عن كل ما وجدته لتعود الحقوق لأصحابها . <p>
              ...
              <div class="maf" style="padding-top: 180px;margin-bottom: 50px;">
                <h2 style="color:#6C63FF; font-family: Tajawal;">كيف يمكننا مساعدتك؟</h2>
                يمكنك من خلالنا رفع طلب في أي وقت احتجت فيه للمساعدة أو في حال اردت مد اليد لمساعدة غيرك
                </div>
                
                <div style="margin-bottom: 50px;">
                <a href="/recordLost" class="button" style="color:white; background-color:#6C63FF; font-family: Tajawal; font-size: 14px; padding: 15px; border-radius: 20px;">  إضافة مفقود او معثور عليه </a>
                </div>
    ...
    <div class="container">
            <table class=table table-hover table-bordered>
             ...
             @foreach($losts  as $lost) 
              ...
              <tr style="background: white;">
                <td style="text-align-last: right;width: 380px;"> 
                 <a href="/showFoundandLost/2" style="font-size:20px;color:#8A2BE2; font-weight: bold;">{{ $found->title }} </a> 
                 <br>
                 <p style="font-size:11px;display: inline-block; margin-right: 5px;"> {{$found->created_at->format('d/m/Y')}} - </p> 
                 <i class="fa fa-map-marker" aria-hidden="true"></i><p style="font-size:11px;display: inline-block; margin-right: 5px;"> {{$found->Place->name_place}}</p> 
                </td>

                <td style="text-align-last: center;width: 300px; padding-top: 35px;">مفقوده</td>

                <td style="text-align-last: left;width: 300px;"><br><i class='far fa-heart' class="heart" style="font-size:24px"></i> </td>
