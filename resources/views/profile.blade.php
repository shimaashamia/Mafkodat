...
<a class="dropdown-item" href="{{ route('logout') }}" style="    display: contents;"
  ...
  <!-- <a href="{{ route('editProfile') }}" class="btn btn-primary">Edit Task</a> -->

<button class="button button2" style="float: left;margin: 40px; background-color:#6C63FF;">  <i class="fas fa-pen"></i>  تعديل الملف الشخصي</button>
</div>
</body>
